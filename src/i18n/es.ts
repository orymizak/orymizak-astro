...
export default {
  ...
  about: {
    techTitle: "Tecnologías usadas en este sitio",
    iconsCopyright: "Íconos provistos por Icons8",
  },
  ...
  drawerLinks: [
    ...
    // { text: "Acerca de", path: "/info" },
  ],

  home: {
    title: "Hola, soy David Orymizak",
  ...
  project: {
    title: "Proyectos",
    projects: [
      { title: "Proyecto 1", description: "Descripción de ejemplo.", img: "/assets/images/test.jpeg" },
      { title: "Proyecto 2", description: "Descripción de ejemplo.", img: "/assets/images/test.jpeg" },
      { title: "Proyecto 3", description: "Descripción de ejemplo.", img: "/assets/images/test.jpeg" },
    ],
  },
  ...
  contact: {
    ...
    description: "Por favor, indica tu nombre, tu mensaje y si quieres añadir algún medio de contacto adicional...",
    sendButton: "Enviar"
  },
